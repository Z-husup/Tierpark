...
INSERT INTO schedule (name, scheduleType, startingTime, enclosure) VALUES
                                                                       ...
                                                                       ('Cleaning Shift', 'Cleaning', '2025-06-01', 2),
                                                                       ('Training Session', 'Activity', '2025-06-02', 3),
                                                                       ('Evening Feeding', 'Feeding', '2025-06-01', 4),
                                                                       ('Vet Check', 'Medical', '2025-06-03', 5);
...
INSERT INTO worker (username, password, fullName, email, phoneNumber, dateOfBirth, gender, hireDate, status, salary, specialization, enclosure) VALUES
                                                                                                                                                    ('worker1', 'pass1', 'Alice Smith', 'alice@zoo.com', '1234567890', '1990-04-20', 'Female', '2020-05-01', 'Active', 2500, 'Veterinary', 1),
                                                                                                                                                    ('worker2', 'pass2', 'Bob Johnson', 'bob@zoo.com', '0987654321', '1985-08-15', 'Male', '2019-03-10', 'Active', 2300, 'Feeding', 2),
                                                                                                                                                    ('worker3', 'pass3', 'Clara Adams', 'clara@zoo.com', '555666777', '1995-12-05', 'Female', '2021-07-20', 'Active', 2400, 'Maintenance', 3),
                                                                                                                                                    ('worker4', 'pass4', 'David Lee', 'david@zoo.com', '444333222', '1988-02-28', 'Male', '2018-11-11', 'Active', 2600, 'Caretaker', 4),
                                                                                                                                                    ('worker5', 'pass5', 'Eva Zhang', 'eva@zoo.com', '321654987', '1992-09-09', 'Female', '2022-01-15', 'Active', 2450, 'Feeding', 5);
